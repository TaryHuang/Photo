...
namespace PhotoJ
{
    ...
    [Table(Name = "ObjDateTable")]
    public class ObjDateTable : INotifyPropertyChanged, INotifyPropertyChanging
    {
        private int gID;
        ...
        private int gDATETYPE;
        [Column(DbType = "int NULL", CanBeNull = false, Storage = "DATETYPE")]
        public int DATETYPE
        {
            get
            {
            ...
            set
            {
                NotifyPropertyChanging("DATETYPE");
                gDATETYPE = value;
                NotifyPropertyChanging("DATETYPE");
            }
        }
        ...
        private int gFORMAT;
        [Column(DbType = "int NULL", CanBeNull = false, Storage = "FORMAT")]
        public int FORMAT
        {
            get
            {
